...
* @property { IColorOrRoll } last - ultima rodada do game
* @property { boolean } entry - responsta da analise de entrada/não entrada
* @property { import("./blaze.mjs").IDataBlazeResponse[] } recents - recentes jogadas do game
 ...
 * @class
 * @classdesc
 * @author Ronaldo Dos Santos
 * 
 * @see GitHub {@link https://github.com/ronaldosantos1001}
 */
